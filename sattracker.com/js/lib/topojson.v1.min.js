topojson = function() {
    ...
    function n(n, t, r) {
        ...
        function c(e) {
            "GeometryCollection" === e.type ? e.geometries.forEach(c) : e.type in d && (f = e,
            d[e.type](e.arcs))
        }
        var s = [];
        if (arguments.length > 1) {
            ...
            c(t),
            l.forEach(arguments.length < 3 ? function(e, n) {
                s.push(n)
            }
            : function(e, n) {
            ...
            for (var p = 0, v = n.arcs.length; v > p; ++p)
                s.push(p);
        return o(n, {
    ...
    function c(e, n) {
        ...
        var r, o = d(e.transform), a = p(e.transform), i = l(f), u = 0;
        for (n || (n = s),
    ...
    function l(e) {
        ...
        function t(n) {
            for (var t = o[n]; ; ) {
                var r = n + 1 << 1
                  ...
                  , i = n
                  , u = o[i];
                if (a < o.length && e(o[a], u) < 0 && (u = o[i = a]),
        ...
        r.remove = function(r) {
            var a = r.index
              , i = o.pop();
            return a !== o.length && (o[i.index = a] = i,
            (e(i, r) < 0 ? n : t)(a)),
            a
        }
        ,
    ...
    function d(e) {
        if (!e)
            return v;
        var n, t, r = e.scale[0], o = e.scale[1], a = e.translate[0], i = e.translate[1];
        return function(e, u) {
            u || (n = t = 0),
            e[0] = (n += e[0]) * r + a,
            e[1] = (t += e[1]) * o + i
